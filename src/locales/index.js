const Translations = {
  en: {
    ...
    i_loading: "...",
    i_chat: "💬",
    i_home: process.env.VUE_APP_ALINA_NAME_SHORT,
    i_channel: "🎥",
    i_info: "i",
    // ###########################################################################################
    TXT_LOGIN: "Log-in",
  ...
  ru: {
    ...
    TXT_FULL_LIST: "Все",
    COUNTER_COMMENTS:
      "нет комментариев | {n} комментарий | {n} комментария | {n} комменнтариев",
    ...
    "User with such email did not request password reset":
      "Пользователь с таким именем не запрашивал сброс пароля",
    ...
    "Password length cannot be less than 8 symbols (field:password)":
      "Пароль должен быть более 8 символов",
    DENIED: "Запрещено",
    "Server error. Status 403":
      "Четыреста Третья ошибка сервера. Вы лезете, куда вас никто не звал",
    FAIL: "ПОТРАЧЕНО",
    SUCCESS: "УСПЕХ",
    Date: "Дата",
    "Message has been sent": "Сообщение отправлено",
    "Message could not be sent. Mailer Error: %s":
      "Сообщение не отправленою %s",
    "Upload failed": "НЕ УДАЛОСЬ! Загрузка обломалась.",
    "File upload limit exceeded. Already uploaded %s files":
      "Превышен лимит на файлы. Уже загружено: %s файлов",

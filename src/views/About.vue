<template>
  <div class="container p-0 alina-ui-test-wrapper">
    <div class="row no-gutters">
      <div class="col">
        <div class="alina-ui-test-unit">
          <h1>Test</h1>
          <div>Test_Body</div>
        </div>
        <div class="clear">&nbsp;</div>
        ...
        <div class="alina-ui-test-unit">
          ...
          <AlinaFileUploader
            :pArrFiles="[{ id: -5, name_human: 'TEST' }]"
          ></AlinaFileUploader>
        </div>
        <div class="clear">&nbsp;</div>
        ...
        <div class="alina-ui-test-unit">
          <h1>aInput</h1>
          <br /><aInput v-model="aInputModel" /> <br /><aInput
            v-model="aInputModel"
            modeEdit="true"
          />
          <br /><aInput
...
export default {
  ...
  data() {
    ...
    return {
      ...
      testEditor: {
        aModel:
          "Ra-ta-ta-ta VeryLongTextNoSpacesVeryLongTextNoSpacesVeryLongTextNoSpacesVeryLongTextNoSpacesVeryLongTextNoSpacesVeryLongTextNoSpacesVeryL",
      },
